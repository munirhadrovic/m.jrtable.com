<?php
	$adresa=" 713 Vine Street Cincinnati, Ohio"; //jako je vazno navesti dobro adresu radi boljeg poziciniranja
	$grad="";//jako je vazno ako adresa ima dva imena povezati ih sa plus
	$skracenica=""; // AKo ne znate skracenicu ostavite praznu
	$telephone=5136214777;// Broj koji se poziva na dugme CALL US
